...
//it then takes in a name from the user and uses a linear search algorithm to see if the name is in
//the array
//name: Jenna Wolf
...
public class Main {
    public static void main(String[] args) {
        ...
        //uses a linear search to see if the name is on the list
        boolean found = false;
        int index = 0;
        for(int i = 0; i < size; i++) {
